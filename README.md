[![Build Status](https://dev.azure.com/moharira/TestProject/_apis/build/status/moharirankita.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/moharira/TestProject/_build/latest?definitionId=2&branchName=master)
